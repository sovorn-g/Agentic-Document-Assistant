...
class DocumentChunker:
    ...
    def create_chunks_single(self, md_path, project_id=None, document_id=None, source_name=None):
    ...
    def __create_child_chunks(
        ...
        for i, p_chunk in enumerate(parent_chunks):
            parent_prefix = document_id or doc_path.stem
            parent_id = f"{parent_prefix}_parent_{i}"
            metadata = {
